...
class AgoraTokenResponse {
  ...
  factory AgoraTokenResponse.fromJson(Map<String, dynamic> json) {
    // Handle the nested structure: response.data contains the actual token data
    final data = json['data'] as Map<String, dynamic>;
    
    return AgoraTokenResponse(
      token: data['agora_token'] as String,
      channelId: data['agora_channelid'] as String,
      uid: data['agora_uid'] is String ? int.parse(data['agora_uid']) : data['agora_uid'] as int,
      expireTime: data['timestamp'] is String ? int.parse(data['timestamp']) : data['timestamp'] as int,
    );
  }
}
