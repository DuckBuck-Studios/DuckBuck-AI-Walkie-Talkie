...
class CallUI {
  ...
  static Widget buildLoadingUI(
    ...
    switch (state) {
      case CallLoadingState.connecting:
        return _buildConnectingState(context, onCancel);
      case CallLoadingState.waitingLong:
        return _buildWaitingLongState(context, onCancel);
      case CallLoadingState.failed:
        return _buildFailedState(context, onCancel, onRetry);
    }
  }

  /// Builds the initial "connecting to your friend" state with shimmer
  static Widget _buildConnectingState(BuildContext context, VoidCallback? onCancel) {
    ...
    return Positioned(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Main connecting content with better spacing
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                // Animated phone icon with proper constraints
                SizedBox(
                ...
                // Shimmer text with proper flex
                Expanded(
                  child:                  _buildAnimatedText(
                    context,
                    text: "Connecting to your friend...", // Removed phone emoji
            ...
            // Cancel button with enhanced styling and proper constraints
            if (onCancel != null)
              ConstrainedBox(
                constraints: BoxConstraints(
              ...
              .slideY(begin: 0.5, end: 0.0, duration: 400.ms, delay: 600.ms),
          ],
        ),
      ),
    )
  ...
  static Widget _buildWaitingLongState(BuildContext context, VoidCallback? onCancel) {
    final screenHeight = MediaQuery.of(context).size.height;
    final screenWidth = MediaQuery.of(context).size.width;
        ...
        child: Column(
          ...
          children: [
            ...
            if (onCancel != null)
              ...
              .animate()
              .fadeIn(duration: 500.ms, delay: 1000.ms, curve: Curves.easeOut)
              .slideY(begin: 0.5, end: 0.0, duration: 500.ms, delay: 1000.ms),
          ],
        ),
      ),
    )
  ...
  static Widget _buildFailedState(BuildContext context, VoidCallback? onCancel, VoidCallback? onRetry) {
    final screenHeight = MediaQuery.of(context).size.height;
    final screenWidth = MediaQuery.of(context).size.width;
    ...
    return Positioned(
      ...
      right: screenWidth * 0.05, // Increased for better margins
      child: GestureDetector(
        onTap: onCancel, // Tap to exit
        onLongPress: onRetry, // Hold to retry
        child: Container(
          constraints: BoxConstraints(
            maxWidth: screenWidth * 0.90, // Reduced from 0.92
            minHeight: screenHeight * 0.12,
  ...
  static Widget buildInstructionUI(
    ...
    return Positioned(
      ...
      child: GestureDetector(
        ...
        child: Container(
          constraints: BoxConstraints(
            maxWidth: screenWidth * 0.90, // Slightly reduced from 0.92
            minHeight: screenHeight * 0.08, // Reduced from 0.1
          ),
          padding: EdgeInsets.symmetric(
            horizontal: screenWidth * 0.04, // Reduced from 0.05
            vertical: screenHeight * 0.015, // Reduced from 0.02
          ),
          decoration: BoxDecoration(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  _buildAnimatedText(
                    context,
                    text: 'Tap to exit',
                    fontSize: screenWidth * 0.038, // Reduced from 0.04
                    color: Colors.white,
                    delay: 200.ms,
                  ),
                ],
              ...
              if (onLongPress != null) ...[
                SizedBox(height: screenHeight * 0.008), // Reduced from 0.012
                
                // Hold instruction (no icon as requested)
                _buildAnimatedText(
                  context,
